...
export const zh = {
  ...
  Content: marked.parse(
    ...
    **1) 学位论文研究总结**
    ...
    学位论文研究总结应不超过 4 页，类似于博士开题报告，可以包括但不限于：简介、相关工作、方法、初步结果、工作计划以及希望专家解答的问题等。请明确说明已完成和未完成的工作，并说明希望从专家获得的反馈。研究总结格式参考 IEEE VGTC 的论文格式（[https://tc.computer.org/vgtc/publications/journal/](https://tc.computer.org/vgtc/publications/journal/)），作者为申请的学生。
...
export const en = {
  ...
  Title: "ChinaVis 2026 Doctoral Colloquium CFP",
  Content: marked.parse(
    `
