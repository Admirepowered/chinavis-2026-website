...
export const zh = {
  ...
  Content: marked.parse(
    ...
    **会议通知下载：** <a href="/2026/registration/announcement.pdf" target="_blank">点击下载</a>
    ...
    现场报到注册：7 月 19 日—7 月 22 日，在会议指定报到地点现场办理注册。

    说明：官方注册网址、注册二维码统一在会议官网、学会公众号、正式通知同步发布。

    ## 注册时间节点

    早鸟价提前注册：**<span style="color: #de0000; font-weight: 700">即日起至 7 月 10 日 23:59 截止</span>**（最优惠价格，推荐优先选择）。

    常规正常注册：7 月 11 日—7 月 18 日。

    现场注册：7 月 19 日—7 月 22 日（价格最高，不建议选择）。
    ...
    <table>
      <thead>
        <tr>
          ...
          <td colspan="2">提前注册<br />截至 7 月 10 日 23:59</td>
          <td colspan="2">正常注册<br />7 月 11 日-18 日</td>
          <td colspan="2">现场注册<br />7 月 19 日-22 日</td>
    ...
    办理方式：统一填报团体报名信息表（点击此处下载 <strong><a href="/2026/registration/团体报名信息表.xlsx" target="_blank">团体报名信息表.xlsx</a></strong>），填写后发送至官方邮箱：chinavis2026_reg@163.com 预约报名。
