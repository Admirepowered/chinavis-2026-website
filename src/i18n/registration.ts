...
export const zh = {
  ...
  Content: marked.parse(
    ...
    **会议通知下载：** <a href="/2026/registration/announcement.pdf" target="_blank">点击下载</a>
    ...
    请根据自身情况选择合适的注册类型。会议论文需要至少一名作者为非学生注册。会员指“中国图像图形学会”会员。点击[这里](http://membership.csig.org.cn/ass/apply/step?fair_id=223)加入中国图像图形学会。**对于非会员人员，建议先申请加入学会，获得会员号后享受优惠价格注册会议。申请入会时请选择可视化与可视分析专委会，并选择专委会委员推荐。**
