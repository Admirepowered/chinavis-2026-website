...
export const zh = {
  ...
  Content: marked.parse(
    `
    第十三届中国可视化与可视分析大会（ChinaVis 2026）将于2026年7月19日至22日在贵阳举行。本次会议由中国图像图形学会主办，可视化与可视分析专委会、贵州省文化遗产数字化保护与开发利用全省重点实验室以及贵阳学院、贵州大学、贵州师范大学、贵州民族大学、贵州财经大学、贵州中医药大学、凯里学院等高校承办，多家合作单位协办。
