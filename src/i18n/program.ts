        ...
        sessions: [
          {
            ...
            speakers: [
              ...
              },
              {
                ...
                photo: PhotoYXR,
                description: {
                  zh: "袁晓如，北京大学智能学院研究员，教材建设博雅特聘教授，大数据分析与应用技术国家工程实验室常务副主任。主要研究方向为可视化通用基础方法及其在社会、人文领域的应用。多次获IEEE VIS, ChinaVis等可视化国内外学术会议最佳论文或提名奖，现任IEEE VIS, PacificVis, ChinaVis指导委员会成员。中国计算机学会杰出会员，中国图像图形学会可视化与可视分析专业委员会主任。",
              ...
              },
              {
                ...
                photo: PhotoZJW,
                description: {
                  zh: "张加万，天津大学智能与计算学部教授、博导、现任贵阳学院党委委员，副校长（对口支援）。担任CSIG常务理事、贵州省文化遗产数字化保护与开发利用全省重点实验室主任、文化部建筑文化遗产保护传承信息技术重点实验室副主任、天津市文化遗产保护与传承工程技术中心主任。以首席科学家完成国家重点研究计划项目1项和国家社科基金重大项目1项。以第一作者（或通讯）在国际著名学术期刊、会议发表学术论文100余篇。获国家发明专利授权20多项。",
                  en: "Jiawan Zhang is a Professor and doctoral supervisor at the School of Intelligence and Computing, Tianjin University. He currently serves as a member of the CPC Guiyang University Committee and Vice President of Guiyang University under the counterpart support program. He is also an Executive Director of CSIG, Director of the Guizhou Provincial Key Laboratory for Digital Protection, Development and Utilization of Cultural Heritage, Deputy Director of the Ministry of Culture Key Laboratory of Information Technology for the Protection and Inheritance of Architectural Cultural Heritage, and Director of the Tianjin Engineering Technology Center for Cultural Heritage Protection and Inheritance. As chief scientist, he has completed one project under the National Key R&D Program of China and one major project funded by the National Social Science Fund of China. He has published more than 100 academic papers as first author or corresponding author in leading international journals and conferences, and has been granted more than 20 national invention patents.",
                  },
              },
              {
                name: {
        ...
        sessions: [
          {
            ...
            speakers: [
              ...
              },
              {
                ...
                description: {
                  zh: "李权，上海科技大学信息科学与技术学院助理教授（终身教授序列）、研究员、博士生导师，从事人工智能及可视分析、可解释性机器学习以及人机交互技术的研究。他博士毕业于香港科技大学计算机科学与工程学系。任中国图像图形学会可视化与可视分析专委会委员，IEEE VIS Paper程序委员会委员、ChinaVis论文国际程序委员会委员、IEEE VIS, EuroVis, PacificVis, ChinaVis, ACM CHI/CSCW及TVCG等顶级学术会议期刊审稿人，他曾任美国佐治亚理工学院计算机科学与工程学院的访问研究员、微众银行人工智能部资深研究员及网易游戏资深研究员。他的学术成果发表在IEEE VIS, EuroVis, IEEE PacificVis, ACM CHI, CSCW, UIST, IUI, CGF, TVCG等可视化及人机交互顶级期刊和会议，获得ACM CHI 2026最佳论文奖，并主持国家自然科学基金面上项目。更多信息见https://faculty.sist.shanghaitech.edu.cn/liquan/",
              ...
              },
              {
                ...
                description: {
                  zh: "石楚涵，东南大学计算机科学与工程学院副教授，博士毕业于香港科技大学计算机科学与工程学系。研究方向包括数据可视化、可视分析、人智协同及其在自然科学、精准医疗等领域的应用，在相关领域的IEEE VIS、IEEE TVCG、ACM CHI、ACM UIST、ACM CSCW等国际顶级期刊和会议发表论文20余篇。任中国图像图形学会可视化与可视分析专委会委员、中国计算机学会人机交互专委会委员，ACM CHI、ACM CSCW等国际权威会议的区域副主席，以及IEEE VIS、ACM UIST、IEEE PacificVis等会议审稿人。更多信息见：https://shichuhan.github.io/",
        ...
        sessions: [
          {
            ...
            speakers: [
              ...
              },
              {
                ...
                description: {
                  zh: "石洋，同济大学设计创意学院副教授，博士生导师，中国图像图形学学会可视化与可视分析专业委员会委员，中国计算机学会人机交互专委会执行委员。她专注于计算机与设计交叉学科，研究方向为可视化设计理论模型和智能可视化设计方法。近年来在可视化、人机交互、人工智能领域国际顶级期刊和会议发表论文，包括IEEE TVCG, ACM CHI, ACM CSCW, AAAI等，并获得可视化领域国际会议IEEE VIS2022最佳论文提名奖2项、IEEE PacificVis2018最佳论文提名奖、ChinaVis2020最佳论文奖。她曾获2022年度中国图像图形学会自然科学奖二等奖（排名2），并入选2019年福布斯中国30岁以下精英榜（科学领域），2023年度ACM SIGCHI中国新星奖。她主持了国家自然科学基金2项、省部级自然科学基金1项。同时，她担任了IEEE VIS2022-2023Meetup主席和IEEE PacificVis2020海报主席。详细信息请访问：https://xiaoyangtao.github.io/",
          ...
          },
          {
            ...
            papers: programPapers["paper-2"].papers,
          },
        ],
      },
      {
      ...
      },
      {
        ...
        sessions: [
          ...
          },
          {
            ...
            papers: programPapers["paper-3"].papers,
          },
          {
            type: "panel",
            id: "panel-2",
      ...
      },
      {
        ...
        sessions: [
          ...
          },
          {
            ...
            papers: programPapers["paper-4"].papers,
          },
          {
            id: "topic-9",
            type: "topic",
    ...
    timeslots: [
      {
        ...
        sessions: [
            ...
            speakers: [
              {
                ...
                description: {
                  zh: "北京大学智能学院研究员，教材建设博雅特聘教授，大数据分析与应用技术国家工程实验室常务副主任。主要研究方向为可视化通用基础方法及其在社会、人文领域的应用。多次获IEEE VIS, ChinaVis等可视化国内外学术会议最佳论文或提名奖，现任IEEE VIS, PacificVis, ChinaVis指导委员会成员。中国计算机学会杰出会员，中国图像图形学会可视化与可视分析专业委员会主任。",
          ...
          },
          {
            ...
            papers: programPapers["paper-5"].papers,
          },
        ],
      },
      {
        ...
        sessions: [
          {
            ...
            speakers: [
              ...
              },
              {
                ...
                description: {
                  zh: "唐兴波，艾迪普科技股份有限公司创始人 、中国产学研合作促进会理事、中国虚拟现实与产业技术平台副理事长、中国信通院元宇宙创新探索方阵个人高级专家、中国图像图形学会会员，自2003年带领团队研发国产3D图形图像实时渲染、跟踪、识别、处理引擎、零代码创作工具及数字资产管理平台。以数字内容产业为依托，结合云计算、大数据、人工智能、区块链等多项前沿技术，构建了数字内容产业全链路闭环体系，广泛应用于虚拟现实、增强现实、虚拟仿真、数字孪生及工业元宇宙等应用领域的产业化。曾参与多项国家核心技术攻关项目与课题。",
        ...
        sessions: [
          {
            ...
            speakers: [
              ...
              },
              {
                ...
                photo: PhotoLiuL,
                description: {
                  zh: `刘乐博士毕业于美国克莱姆森大学，现任西北工业大学副教授，空天地海一体化大数据应用技术国家工程实验室可视互动方向负责人，入选陕西省高层次人才、陕西省高校青年创新团队，担任中国图像图形学会可视化与可视分析专委会秘书、中国可视化与可视分析大会网站主席、智能视觉产业发展大会专题主席等。长期从事可视化、视觉认知、计算机图形学和人工智能交叉领域研究，在IEEE VIS、TVCG、IJCV、IMWUT 、ACM MM等会议和期刊发表论文近30篇，成果获得Scientific American、US Newsweek、雅虎、中国网等国内外知名媒体专题报道。主持国家自然科学基金等项目。获教育部和科技部颁发"春晖杯"中国留学人员创新创业大赛优胜奖。指导学生获得中国国际大学生创新大赛全国银奖。`,
