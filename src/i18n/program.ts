        ...
        "sessions": [
          {
            ...
            "details": [
              ...
              {
                "zh": "嘉宾：屈华民（香港科技大学）；崔辰州（中国科学院国家天文台）；董军宇（中国海洋大学）；王建（国家对地观测科学数据中心副主任）；刘洪波（北京工程软件研制中心）",
                "en": "Panelists: Huamin Qu (Hong Kong University of Science and Technology); Chenzhou Cui (National Astronomical Observatories, Chinese Academy of Sciences); Junyu Dong (Ocean University of China); Jian Wang (Deputy Director, National Earth Observation Data Center); Hongbo Liu (Beijing Engineering Software Development Center)"
              }
            ]
          }
        ]
