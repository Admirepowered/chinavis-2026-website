    ...
    "guests": [
      {
        "name": "门澍",
        "affiliation": "中国美术学院",
        "reportTitle": "声・器・锡：一件可视化作品背后的非遗转译实验",
        "abstract": "本次分享围绕展览交互可视化作品《锡 Tin》，展开以声音交互为核心的永康锡雕非遗活化实践复盘。作品提取传统锡雕全套工具击打声响完成编曲，依据工具声效节奏对应生成独立动态图形，搭建沉浸式空间视听系统。依托实物工具触发交互机制，观众自主操作即可自由组合音画元素，形成随机合奏，实现打锡工艺流程的时空叠合表达。分享将从非遗声音资源数字化转译、感官交互叙事、手工艺当代展陈创新三个维度，剖析数字交互如何重构传统锡雕的观赏逻辑，为传统手工艺活态传承提供新媒体创作实践参考。",
        "bio": "门澍，本科与硕士阶段均就读于中国美术学院视觉传播学院内容谱系工作室，长期深耕系统化视觉创作，创作方向聚焦平面设计、界面交互以及跨媒介数字多媒体设计。依托工作室以内容叙事为核心的研究体系，持续探索静态平面语言与动态数字媒介的融合表达，擅长挖掘信息内核，将抽象概念、文本数据转化为兼具逻辑性与艺术性的完整视觉方案。\n" +
      ...
      {
        "name": "张儒赫",
        "affiliation": "鲁迅美术学院，副教授",
        "reportTitle": "生成式人工智能辅助下的中国古籍信息可视化设计",
        "abstract": "传统古籍与图像文献的传播方式正逐渐由完整阅读转向碎片化消费，图像局部、人物形象与文化符号成为公众接触地域文化的重要入口。然而，碎片化传播在提升传播效率的同时，也使图像内部的人物、器物、行为与场景等信息被割裂，削弱了用户对画面整体叙事及信息关联的理解。报告以包括贵州地区重要文献在内的中国古籍为研究对象，从信息交互可视化设计视角出发，将文本、图像、声音等视为由人物、器物、行为、场景等多维信息共同构成的艺术可视化系统，提出面向古籍传播的信息交互设计方法。研究综合运用图像分割、语义标注、可视化表达与交互设计等方法，构建图像语义档案及交互式可视化网站平台，帮助用户建立从局部细节到整体画面的认知路径。重点探讨信息交互可视化设计如何通过重构信息内部的数据关联，提升古籍传播的吸引力和理解力，为数字人文背景下文化遗产的数字传播提供新的设计思路与实践路径。",
        "bio": "张儒赫，鲁迅美术学院中英数字媒体（数字媒体）艺术学院副教授，硕士生导师，主研信息可视化设计。本、硕分别毕业于中央美术学院、伦敦艺术大学，博士在读，芬兰阿尔托大学访问学者。中国图像图形学学会可视化与可视分析专委会委员，西安平面设计师协会会员，辽宁省美术家协会会员。参与2008年北京奥运会“金镶玉”奖牌设计、北京奥运会开闭幕式舞台和道具设计。作品入选中华人民共和国第十二届运动会吉祥物十佳作品，并参与中华人民共和国第十二届运动会宣传画设计。担任国家艺术基金2025年度传播交流推广项目特邀策展人。获第六届全国数字创意教学技能大赛一等奖、第十二届全国美术作品展览获奖提名、红点奖品牌与传达奖、Hiiibrand Awards字体编排金奖、虎啸奖金奖、金犊奖年度全场大奖等。“十四五”普通高等教育本科/高职国家级规划教材建设，多篇论文发表于中文核心期刊、SCI国际期刊等。",
        "photo": zrh
      },
      {
        "name": "谢继武",
        "affiliation": "内蒙古师范大学设计学院，副教授",
        "reportTitle": "北疆智韵：区域文化从数字到数智的转化与应用转译",
        "abstract": "该主题聚焦内蒙古区域非遗服饰文化依托生成式人工智能AIGC的数智化实践，重点解决民族地区垂直领域生成图像特征准确性问题。案例通过北疆智韵的数据搜集、模型训练与平台构建，探讨AIGC技术在民族非遗文化保护、传承与创新应用，构建符合民族地区区域数据的AIGC典型性应用模式。以提供精准化、多样化的AIGC服务，构建基于北疆文化特征训练的有自主产权的人工智能平台，服务于北疆文旅文博产业创新、文化艺术教育领域、服装服饰创新、设计创新、动漫影视游戏产业等领域，促进区域的生产力提升与产业发展。",
        "bio": "谢继武，副教授，博士，内蒙古师范大学设计学院艺术与科技系主任、澳大利亚迪肯大学访问学者。兼任内蒙古动漫学会会长，内蒙古人工智能学会数智文旅专委会副主任。近年来聚焦信息可视化与可视分析、人工智能创新应用交叉学科领域方向研究。著有《数智化民族服饰创新》等专著与教材4部；主持教育部协同育人项2项；主持中央引导地方科技发展资金项目、省部级教育规划课题、哲社课题等10余项；作为主要参与人完成国家艺术基金项目2项；中外合作办学研究项目课题1项；发表论文10余篇，指导学生在设计作品在全国高校数字艺术设计大赛、学院奖等各类设计大赛中获奖60余项。",
        "photo": xjw
      }
    ]
  },
