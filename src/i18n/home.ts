...
export const en = {
  ...
  Content: marked.parse(
    ...
    The China Visualization and Visual Analytics Conference (ChinaVis) was jointly initiated by members of the visualization community in China. It aims to promote exchanges in visualization and visual analytics research and applications across China and neighboring regions; explore the directions and opportunities for visualization and visual analytics in the era of big data; advance related research and applications; promote the development of the discipline; foster talent development and exchange; and deepen the integration of art and technology. The conference provides a platform for face-to-face exchanges with renowned experts, entrepreneurs, and representatives from application sectors in China and abroad, facilitating in-depth discussions on cutting-edge visualization technologies and their applications. It also promotes the formation of a new ecosystem for the coordinated development of industry, academia, research, and application in the field of visualization and visual analytics in China. ChinaVis has previously been held in Beijing (2014), Tianjin (2015), Changsha (2016), Qingdao (2017), Shanghai (2018), Chengdu (2019), Xi’an (2020), Wuhan (2021), Xining (2022), Chongqing (2023), Hong Kong (2024), and Hangzhou (2025). These conferences brought together hundreds of visualization researchers and domain experts from China and abroad and were met with great success.
